...
package uc15.etapa6.zeroandar.service;

import uc15.etapa6.zeroandar.repository.ClienteDAO;
import uc15.etapa6.zeroandar.repository.jdbc.JdbcClienteDAO;
import uc15.etapa6.zeroandar.model.PessoaCliente;
...
/**
 * Service responsavel pelas operacoes de negocio de Clientes.
 *
 * Aplicacao dos principios SOLID:
 *   - S (Single Responsibility): este controller cuida apenas das
 *     regras de negocio de Cliente. Validacao foi movida para
 *     ValidacaoService. Persistencia fica no ClienteDAO.
 *   - D (Dependency Inversion): depende da interface ClienteDAO,
 *     nao da implementacao concreta ClienteDAO. Isso permite trocar
 *     a implementacao sem alterar este controller.
 *
 * Refatoracao em relacao ao PI2:
 *   - Metodos adicionar() e atualizar() agora retornam boolean
 *     (antes retornavam void e imprimiam no console).
 *   - Validacao de dados realizada antes de persistir.
 *   - Mensagens de erro nao sao mais impressas no console:
 *     o chamador recebe false e decide o que exibir.
 */
public class ClienteService {
    ...
    /**
     * Valida os dados obrigatorios do cliente antes de persistir.
     * Delega ao ValidacaoService — aplicacao do principio S.
     *
