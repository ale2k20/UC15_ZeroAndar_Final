...
import uc15.etapa6.zeroandar.repository.ImovelDAO;
import uc15.etapa6.zeroandar.repository.jdbc.JdbcImovelDAO;
import uc15.etapa6.zeroandar.model.Imovel;
...
/**
 * Service responsavel pelas operacoes de negocio de Imoveis.
 *
 * Aplicacao dos principios SOLID:
 *   - S (Single Responsibility): cuida apenas das regras de negocio
 *     de Imovel.
 *   - D (Dependency Inversion): depende da interface ImovelDAO.
 *
 * Refatoracao em relacao ao PI2:
 *   - Metodos adicionar(), atualizar() e excluir() retornam boolean.
