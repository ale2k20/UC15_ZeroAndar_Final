...
/**
 * Servico responsavel EXCLUSIVAMENTE por validacoes de dados do sistema.
 *
 * Aplicacao do principio SOLID:
 *   - S (Single Responsibility): esta classe tem uma unica responsabilidade,
 *     validar dados. Nenhuma outra classe do sistema precisa conter
 *     logica de validacao.
 *
 * Antes da refatoracao, validarCpf() existia dentro de Pessoa.java e
 * validarCep() / validarEstado() dentro de Endereco.java, misturando
 * responsabilidades com as classes de modelo.
 */
public class ValidacaoService {

    /**
     * Valida CPF brasileiro.
     * Remove formatacao (pontos e traco) antes de validar.
     * Verifica digitos verificadores conforme algoritmo da Receita Federal.
     *
