 ...
 * páginas do front-end (HTML/CSS/JS) que estão em
 * {@code src/main/resources/static}.
 *
 * <p>Diferente da {@link uc15.etapa8.zeroandar.test.Main}, que é apenas
 ...
 * web.</p>
 *
 * <p>Nesta etapa (8) ainda não há Controllers, Services do Spring ou
 * conexão com banco de dados: o Tomcat apenas serve os arquivos estáticos
 * prontos. Na Etapa 9, os {@code @Controller}/{@code @RestController}
 * serão adicionados neste mesmo pacote, reaproveitando as classes de
