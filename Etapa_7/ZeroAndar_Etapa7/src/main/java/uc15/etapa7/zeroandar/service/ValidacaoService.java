 ...
 *
 * Aplicacao do principio SOLID: - S (Single Responsibility): esta classe tem
 * uma unica responsabilidade, validar dados. Nenhuma outra classe do sistema
 * precisa conter logica de validacao.
 *
