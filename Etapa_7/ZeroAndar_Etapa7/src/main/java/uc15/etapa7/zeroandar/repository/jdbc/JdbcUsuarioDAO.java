...
import uc15.etapa7.zeroandar.model.Pessoa;

/**
 * Data Access Object para Usuario (Sistema de Login) Gerencia autenticação e
 * controle de acesso
 */
public class JdbcUsuarioDAO {
    ...
    /**
     * Autentica usuário (Login) Retorna a Pessoa associada se login válido
     */
    ...
    /**
     * Gera hash da senha (SHA-256 simples para testes) IMPORTANTE: Em producao,
