...
public class JdbcProprietarioDAO implements ProprietarioDAO {
    ...
    public int inserir(PessoaProprietario proprietario) throws SQLException {
        ...
        try {
            ...
            if (proprietario.getTelefone() != null && !proprietario.getTelefone().isBlank()) {
                ...
                try (PreparedStatement stmt = connection.prepareStatement(sqlTelefone)) {
                    stmt.setInt(1, proprietario.getIdPessoa());
    ...
    private PessoaProprietario extrairProprietario(ResultSet rs) throws SQLException {
        ...
        proprietario.setTelefone(buscarTelefonePrincipal(rs.getInt("id_pessoa")));
    ...
    /**
     * Busca proprietarios por texto.
     *
     * O filtro da tela de Proprietarios utiliza este metodo para pesquisar
     * diretamente no banco por nome, e-mail ou CPF.
     */
    @Override
    public List<PessoaProprietario> buscarPorTexto(String texto) throws SQLException {
        List<PessoaProprietario> lista = new ArrayList<>();
