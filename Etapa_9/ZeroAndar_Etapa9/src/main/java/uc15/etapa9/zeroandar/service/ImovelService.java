...
public class ImovelService {
    ...
    public Imovel buscarPorId(int idImovel) {
        try {
            return ((uc15.etapa9.zeroandar.repository.ImovelDAO) imovelDAO).buscarPorId(idImovel);
        } catch (SQLException e) {
            return null;
        }
    }
    ...
    public List<Imovel> buscarPorTexto(String texto) {
        try {
            return imovelDAO.buscarPorTexto(texto);
        } catch (SQLException e) {
            return new ArrayList<>();
        }
    }
